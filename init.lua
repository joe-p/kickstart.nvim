...
require('lazy').setup({
  ...
  },
  {
    ...
    keys = {
      ...
      { '<leader>/', function() Snacks.picker.grep() end, desc = 'Grep Current Buffer' },
      ...
      -- git
      { '<leader>gc', function() Snacks.picker.git_log() end, desc = 'Search [G]it [C]ommits' },
      ...
      { '<leader>sw', function() Snacks.picker.grep_word() end, desc = 'Search Visual Selection or [W]ord', mode = { 'n', 'x' } },
      -- search
      ...
      { '<leader>sS', function() Snacks.picker.colorschemes() end, desc = '[S]earch Color [S]phemes' },
